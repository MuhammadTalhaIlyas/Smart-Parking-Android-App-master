                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if(parkingArea.availableSlots>0) {
                                        ...
                                        Boolean isUpiPaymentSuccessful = upiPayment.payUsingUpi(String.valueOf(bookingSlot.amount), upiInfo.upiId, upiInfo.upiName, note, BookParkingAreaActivity.this);
                                        String upi2="micsilveira111@oksbi"+ "Michael"+ note + BookParkingAreaActivity.this;
